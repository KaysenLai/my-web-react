...
const DemoSage = (props: demoPageProps) => {
  ...
  //---------Redux saga demo 1: async request, store and clear state---------
  ...
  //---------Redux saga demo 2: async request with variable---------
  ...
  //---------Redux saga demo 3: select a store State when sending async request---------
